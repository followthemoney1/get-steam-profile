...
public class ViewUtils {
    ...
    public static void showSnackBarWithDelay(View v, String message, int delay){
        Snackbar.make(v,message,delay).show();
    }

    public static void showAlertDialog(Context context, String title, String message, final DialogCallback callback){
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.AlertDialogDark);
